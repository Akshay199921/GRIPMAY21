...
<style>
  ...
  body{
    background-image: url('./img/transaction2.jpg'); 
...
<html lang="en">
  ...
  <button type="button" class="btn btn-outline-warning"><a href="index.php">Goback</a></button>
...
<?php
    ...
    $sql_execute = mysqli_query($conn, $sql1);
