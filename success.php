  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sender = $_POST['uid'];
            ...
            if($sending_money<=$sender_bal){
                ...
                $val7 = mysqli_query($conn, $sql7);

                $sql8 = "INSERT INTO `transactions` (`Sender`, `Receiver`, `Money`, `Date`) VALUES ('$sen_name', '$rec_name', '$sending_money', current_timestamp());";
                $val8 = mysqli_query($conn,$sql8);

                echo '<div class="alert alert-info" role="alert">
                <h1 class="alert-heading">Transaction Succesful!</h1>
                <p>Payment Was succeful.</p>
                <hr>
                <p class="mb-0">Watch all the previous transactions <a href="transactions.php">
                here</a> 
                </p><br>
              </div>';
                echo "<div class='style_but'>
                <button type='button' class='btn btn-outline-success'><a href='index.php'>Go back to first Page</a></button>
                </div> ";
